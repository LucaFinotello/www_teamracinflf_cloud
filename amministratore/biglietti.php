...
<html>
	...
	<div id="main">
		...
		<div id="contenuto">
		<?php
			$strsql = "select * from biglietti group by data";
			...
			if (! $riga)
			{		
			 echo "<div class='tabella'>Nessun biglietto presente nel Database" . "<br>";
			  }
			else
			{
			?>
			<p>Elenco biglietti</p>
			<table>
				<tr>
					<th>Data</th>
					<th>Prezzo</th>
