		...
		<div id="contenuto">
			<?php
				...
				if (! $riga)
					...
					{
					   echo "Dati evento da cancellare" . "<br>" ;
			?>
			<form action="cancellabiglietto.php" method="POST" >
				...
				<span class="capo">Disponibilit&agrave;: <input readonly name="disponibilita" type="text" value="<?php echo $riga["disponibilita"]?>"></span>
				<input type="submit" value="CANCELLA" name="Invio"></span></p>
			</form>
			<?php
			}
			?>
		<p><a href="cancellabiglietti.php">Indietro</a></p>
		</div>
	</div>
	<div id="footer">
		Area Amministratore
