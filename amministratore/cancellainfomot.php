	...
	<div id="main">
		...
		<div id="contenuto">
			<?php
				...
				$anno = $_POST["anno"];
				$strsql = "select * from infomoto where modello = '$modello' and anno = '$anno'";
			...
			?>
			<form action="cancellainfmot.php" method="POST" >
				<p><span class="capo">Marca: <input readonly name="marca" type="text" value="<?php echo $riga["marca"]?>"></span>
				<span class="capo">Modello: <input readonly name="modello" type="text" value="<?php echo $riga["modello"]?>"></span>
				<span class="capo">Anno: <input readonly name="anno" type="text" value="<?php echo $riga["anno"]?>"></span>
				<span class="capo">Immagine: <input readonly name="immagine" type="text" value="<?php echo $riga["immagine"]?>"></span>
				<span class="capo">Descrizione: <textarea readonly name="descrizione" type="text" value="<?php echo $riga["descrizione"]?>"></textarea></span>
				<span class="capo">Prezzo: <input readonly name="prezzo" type="text" value="<?php echo $riga["prezzo"]?>"></span>
				<span class="capo">Disponibilita: <input readonly name="disponibilita" type="text" value="<?php echo $riga["disponibilita"]?>"></span>
				<input type="submit" value="CANCELLA" name="Invio"></span></p>
			</form>
			<?php
			}
			?>
		<p><a href="cancellainfomoto.php">Indietro</a></p>
		</div>
	</div>
	<div id="footer">
		Area Amministratore
