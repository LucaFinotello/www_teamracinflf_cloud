...
<html>
	...
	<div id="main">
		...
		<div id="contenuto">
			<h2>Inserire info moto da cercare:</h2>  
			<form action="cancellainfomot.php" method="POST" >
				<p>Modello: <input name="modello" type="text" value=""> Anno: <input name="anno" type="text" value="">
