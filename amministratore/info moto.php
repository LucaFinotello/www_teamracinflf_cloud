...
<html>
	...
	<div id="main">
		...
		<?php
			...
			if (! $riga)
				  {
				   echo "nessuna info sulle moto";
				  }
				else
				{
			     while ($riga)
					{
						echo "<div class='Box_Contenitore'>".$riga["marca"]." ".$riga["modello"]." ";
						echo " Prezzo: ".$riga["prezzo"]." &euro; ";
						echo " Diponibilita: ".$riga["disponibilita"]." ";
						echo "<img src='../immagini/".$riga["immagine"]."' alt='".$riga["immagine"]."'>";
						echo "<div class='Box_ContenitoreOverflow'>".$riga["descrizione"]."</div></div>";
						$riga = mysqli_fetch_array($risultato);
					}
				}
				?>
