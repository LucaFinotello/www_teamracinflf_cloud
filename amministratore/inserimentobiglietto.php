...
<html>
	...
	<div id="main">
		...
		<div id="contenuto">
			...
			$strsql = "insert into biglietti (data, prezzo, disponibilita) values ('$data', '$prezzo', '$disponibilita')";
			$risultato = mysqli_query($strsql);
			if (! $risultato)
			  {
			...
			{
			echo "Biglietto inserito con successo!" . "<br>".
			"<a href='biglietti.php'>Visualizza </a>";
			}
			?>
		</div>
	</div>
