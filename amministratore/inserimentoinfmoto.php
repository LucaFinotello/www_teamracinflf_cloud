...
<html>
	...
	<div id="main">
		...
		<div id="contenuto">
			...
			$strsql = "insert into infomoto (marca, modello, anno, immagine, descrizione, prezzo, disponibilita) values ('$marca', '$modello', '$anno', '$immagine', '$descrizione', '$prezzo', '$disponibilita')";
			...
			{
			echo "Annuncio inserito con successo!" . "<br>".
			"<a href='info moto.php'>Visualizza </a>";
			}
			?>
		</div>
	</div>
