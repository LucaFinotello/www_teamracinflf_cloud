...
<html>
	...
	<div id="main">
				...
				<ul>
					...
					<li><a href="#">Modifica</a>
					   <ul>
							...
							<li><a href="ricercamoto.php">Moto</a></li>
					...
					<li><a href="#">Cancella</a>
					   <ul>
							...
							<li><a href="cancellamoto.php">Moto</a></li>
		...
		<div id="contenuto">
			<h2>Inserimento info moto</h2>  
			<form action="inserimentoinfmoto.php" method="POST">
				 <p><span class="capo">Marca: <input name="marca" type="text" value=""></span>
				 <span class="capo">Modello: <input name="modello" type="text" value=""></span>
				 <span class="capo">Anno: <input name="anno" type="text" value=""></span>
				 ...
				 <span class="capo">Prezzo: <input name="prezzo" type="text" value=""></span>
				 <span class="capo">Disponibilit&agrave;: <input name="disponibilita" type="text" value=""></span>
