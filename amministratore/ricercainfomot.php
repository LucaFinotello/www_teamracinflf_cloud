		...
		<div id="contenuto">
			<?php
				...
				if (! $riga)
					...
					{
					   echo "Modificare i Dati dell&rsquo;annuncio:" . "<br>" ;
			?>
				<form action="modificainfomoto.php" method="POST" >
				   <p><span class="capo">Marca: <input name="marca" type="text" value="<?php echo $riga["marca"]?>"></span>
				   <span class="capo">Modello: <input readonly name="modello" type="text" value="<?php echo $riga["modello"]?>"></span>
				   <span class="capo">Anno: <input name="anno" type="text" value="<?php echo $riga["anno"]?>"></span>
				   <span class="capo">Immagine: <input name="immagine" type="text" value="<?php echo $riga["immagine"]?>"></span>
				   <span class="capo">Descrizione: <textarea name="descrizione" value="<?php echo $riga["descrizione"]?>"></textarea></span>
				   <span class="capo">Prezzo: <input name="prezzo" type="text" value="<?php echo $riga["prezzo"]?>"></span>
				   <span class="capo">Disponibilita: <input name="disponibilita" type="text" value="<?php echo $riga["disponibilita"]?>"></span>
				   <span class="capo"><input type="submit" value="Invia" name="Invio"></span></p>
				</form>
			<?php
					}
			?>	
				<p><a href="ricercainfomoto.php">Indietro</a></p>
		</div>
	</div>
	<div id="footer">
		Area Amministratore
