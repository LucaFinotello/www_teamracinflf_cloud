...
<table class="main">
<tr>
  <td><div id="header_messages">Main Chat</div><div id="messages"></div></td>
  <td><div id="header_users"   >Users    </div><div id="users"   ></div></td>
</tr>
<tr>
<td colspan="2">
  <form class="send" action="" onsubmit="chat_msg_add(); return false;">
  <table>
  <tr>
...
Asterisk to the right of a username marks ananswered private message. /
...
for ($r = 0; $r < 6; $r++) for ($g = 0; $g < 6; $g++) for ($b = 0; $b < 6; $b++)
{
  ...
  ?><area href="javascript:chat_color('#<?=$col;?>');" coords="<?=$x*8+2;?>,<?=$y*8+2;?>,<?=$x*8+8;?>,<?=$y*8+8;?>" alt="" /><?php
  if ($x == 17) $y++;
  if ($x != 17) $x++; else $x = 0;
}
?>
...
<div class="padding">
<form action="" onsubmit="chat_msg_log(false); return false;">
...
<div class="menu_form_exit" id="glogin_exit">&nbsp;</div>Login Ospite
</div>
<div class="menu_form_body">

<div class="padding">
<form action="" onsubmit="chat_msg_log(true); return false;">
...
if ($handle = opendir($dir))
{
  while (false !== ($filename = readdir($handle)))
  {
    ...
    if ($pathinfo['extension'] == 'gif')
    {
      ...
      <a href="javascript:chat_smiley('<?=basename($filename, '.gif');?>');"><img src="<?=$chat_path;?>smileys/<?=$pathinfo['basename'];?>" alt="" /></a>
      <?php
    }
  }
  closedir($handle);
